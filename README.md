...
The repository contains the Flutter source code, pubspec.yaml, README, and project files required to run the assignment.
...
The application combines REST API integration, asynchronous UI handling and local storage in one practical Flutter project.